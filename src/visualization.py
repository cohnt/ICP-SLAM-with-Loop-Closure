...
def draw_occupancy_grid(ax, occupancy_grid, cell_size, origin_location):
	...
	# occupancy_grid should be a (h, w) numpy array of integers between -256 and 255.
	...
	ax.imshow(occupancy_grid, origin="lower", extent=(left, right, bottom, top), cmap=plt.get_cmap("binary"))
...
def draw_icp_iteration(ax, pc1, pc2, correspondences=None):
	...
	# numpy array of integers, showing the matched pairs.
